...
dScdt=k0 -       k*Ec*Sc/(1+Sc)                   -     beta* Sc   - eta*(Epsilon_rd*Sc-So);
dSodt=   - theta*k*Eo*So/(1+So)                   -     beta* So   - eta*(So-Epsilon_rd*Sc)/gamma;
...
J=[dScdt;dSodt;dIcdt;dIodt;dAcdt;dAodt];
end
